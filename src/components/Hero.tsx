const Hero = () => {
	return (
		<section className=' h-screen relative z-10 flex-col justify-center text-center px-4 w-full'>
			<div className='h-[72%] md:h-[79%] bg-red-300 top-[15vh] md:top-[16vh] border-zinc-700 border rounded-[2rem] relative w-full flex flex-col justify-center items-center pb-14 overflow-hidden shadow-2xl'>
